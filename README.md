...
[![Packagist](https://img.shields.io/packagist/dt/ravesoft/yii2-recaptcha-widget.svg)]() [![Packagist](https://img.shields.io/packagist/v/ravesoft/yii2-recaptcha-widget.svg)]()  [![license](https://img.shields.io/badge/License-MIT-yellow.svg)]()
...
```
php composer.phar require --prefer-dist "ravesoft/yii2-recaptcha-widget" "*"
```

or add

```json
"ravesoft/yii2-recaptcha-widget" : "*"
```
...
'components' => [
    'reCaptcha' => [
        'class' => 'ravesoft\yii2\recaptcha\ReCaptchaConfig',
...
'container' => [
    'definitions' => [
        ravesoft\yii2\recaptcha\ReCaptcha2::className() => function ($container, $params, $config) {
            return new ravesoft\yii2\recaptcha\ReCaptcha2(
                'your siteKey v2',
                '', // default
                $config
            );
        },
        ravesoft\yii2\recaptcha\ReCaptchaValidator2::className() => function ($container, $params, $config) {
            return new ravesoft\yii2\recaptcha\ReCaptchaValidator2(
                'your secret key v2',
                '', // default
                null, // default
                null, // default
...
public function rules()
{
  return [
      // ...
      [['reCaptcha'], \ravesoft\yii2\recaptcha\ReCaptchaValidator2::className(),
...
public function rules()
{
  return [
      // ...
      [['reCaptcha'], \ravesoft\yii2\recaptcha\ReCaptchaValidator3::className(),
        'secret' => 'your secret key', // unnecessary if reСaptcha is already configured
        'threshold' => 0.5,
        'action' => 'homepage',
      ],
...
<?= $form->field($model, 'reCaptcha')->widget(
    \ravesoft\yii2\recaptcha\ReCaptcha2::className(),
    [
...
```php
<?= $form->field($model, 'reCaptcha')->widget(
    \ravesoft\yii2\recaptcha\ReCaptcha3::className(),
    [
        'siteKey' => 'your siteKey', // unnecessary is reCaptcha component was set up
        'action' => 'homepage',
    ]
...
v2
```php
<?= \ravesoft\yii2\recaptcha\ReCaptcha2::widget([
    'name' => 'reCaptcha',
    'siteKey' => 'your siteKey', // unnecessary is reCaptcha component was set up
...
v3
```php
<?= \ravesoft\yii2\recaptcha\ReCaptcha3::widget([
    'name' => 'reCaptcha',
    'siteKey' => 'your siteKey', // unnecessary is reCaptcha component was set up
    'action' => 'homepage',
    'widgetOptions' => ['class' => 'col-sm-offset-3'],
